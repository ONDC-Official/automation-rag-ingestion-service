    ...
    try:
        ...
        for collection_name in collections:
            try:
                ...
                # If metadata is broken, we tell the user but don't stop the whole script
                print(
                    f"[WARN] Could not drop {collection_name} due to metadata sync issue. Manual restart may be needed."
                )
