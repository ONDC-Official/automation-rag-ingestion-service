...
This is a group of **6** sub-validation(s) that all must pass: REQUIRED_QUOTE_ID, REQUIRED_QUOTE_PRICE, REQUIRED_QUOTE_PRICE_CURRENCY, REQUIRED_QUOTE_TTL, VALID_QUOTE_TTL_REGEX, and REQUIRED_QUOTE_BREAKUP.
...
This is a group of **2** sub-validation(s) that all must pass: REQUIRED_PAYMENT_TYPE and VALID_PAYMENT_TYPE_ENUM.
