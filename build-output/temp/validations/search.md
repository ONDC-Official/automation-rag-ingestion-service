...
- All elements of $.message.intent.category.descriptor.code must be in ["GOLD_LOAN", "PERSONAL_LOAN", "CREDIT_CARD"]
...
> **Skip if:**
> - None of $.message.intent.category.descriptor.code may be in ["PERSONAL_LOAN"]
...
- At least one of $.message.intent.payment.tags[*].descriptor.code must be in ["BUYER_FINDER_FEES", "SETTLEMENT_TERMS"]
