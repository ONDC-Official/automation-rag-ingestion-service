...
There are **60** validation rules organized into **7** top-level group(s).
...
- All elements of $.message.order.items[*].xinput.head.headings[*] must be in ["INDIVIDUAL_KYC", "BUSINESS_KYC", "SET_LOAN_AMOUNT", "SET_DOWN_PAYMENT", "MANUAL_VERIFICATION"]
