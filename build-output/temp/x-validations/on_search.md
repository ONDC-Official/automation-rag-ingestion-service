...
```json
{
  "_TESTS_": {
    "on_search": [
      ...
      {
        "_NAME_": "ON_SEARCH_CATEGORIES_PL",
        "_SCOPE_": "$.message.catalog.providers[*].categories[?(@.descriptor.code=='PERSONAL_LOAN')]",
        "_RETURN_": [
          {
      ...
      {
        "_NAME_": "ON_SEARCH_CATEGORIES_CC",
        "_SCOPE_": "$.message.catalog.providers[*].categories[?(@.descriptor.code=='CREDIT_CARD')]",
        "_RETURN_": [
          {
            "_NAME_": "REQUIRED_CATEGORIES_NAME",
            "attr": "$.message.catalog.providers[*].categories[*].descriptor.name",
      ...
      },
      {
        ...
        "_RETURN_": [
          ...
          {
            "_NAME_": "REQUIRED_GENERAL_INFO_LIST_CC",
            "_SCOPE_": "$.message.catalog.providers[*].items[*].tags[?(@.descriptor.code=='GENERAL_INFO')]",
            "subTags": "$.list[*].descriptor.code",
            "validValues": [
              "WELCOME_BENEFIT",
