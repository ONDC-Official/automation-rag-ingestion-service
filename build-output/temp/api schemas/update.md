# ═══════════════════════════════════════════════════════════
# ONDC Beckn API — "update" action — valid field paths
# ═══════════════════════════════════════════════════════════
#
# HOW TO READ:
...
# $.context.key
# $.message.order.tags[*].descriptor.media[*].url
# $.message.order.xinput.head.descriptor.images[*].width
# $.message.order.quote.breakup[*].item.xinput.form.mime_type
# $.message.order.items[*].descriptor.additional_desc.content_type
# $.message.order.provider.items[*].return_terms[*].return_location.id
# $.message.order.provider.tags[*].descriptor.additional_desc.content_type
# $.message.order.fulfillments[*].agent.person.tags[*].descriptor.media[*].url
# $.message.order.provider.categories[*].tags[*].list[*].descriptor.images[*].width
# $.message.order.provider.fulfillments[*].customer.person.tags[*].list[*].descriptor.code