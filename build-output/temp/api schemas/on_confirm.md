# ═══════════════════════════════════════════════════════════
# ONDC Beckn API — "on_confirm" action — valid field paths
# ═══════════════════════════════════════════════════════════
#
# HOW TO READ:
...
# $.error.code
# $.message.order.quote.breakup[*].item.time.days
# $.message.order.quote.breakup[*].price.estimated_value
# $.message.order.quote.breakup[*].item.xinput.head.index.cur
# $.message.order.provider.tags[*].list[*].descriptor.media[*].url
# $.message.order.provider.items[*].add_ons[*].tags[*].list[*].display
# $.message.order.provider.items[*].tags[*].descriptor.additional_desc.url
# $.message.order.billing.organization.descriptor.additional_desc.content_type
# $.message.order.quote.breakup[*].item.xinput.head.descriptor.images[*].size_type
# $.message.order.provider.fulfillments[*].customer.person.tags[*].descriptor.media[*].dsa